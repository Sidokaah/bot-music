...
module.exports = {
  ...
  execute(message) {
    ...
    .setColor('RANDOM')
    .setTitle('<:headset:871232039427395625> ▸ Wavve™ | Comandos de `Musica`')
    .setAuthor('Nike Music™ | Prefixo: [nk.]') //'https://cdn.discordapp.com/attachments/713525597027958797/724133741236191272/nf1yen2ub3l2riq1g9x2.png', 'https://discord.gg/bPX94q6')
    ...
    .setTimestamp()
    .setFooter('Copyright ©️ 2020 Nike Music™. All Rights Reserved.')// 'https://cdn.discordapp.com/attachments/713525597027958797/724133741236191272/nf1yen2ub3l2riq1g9x2.png');
